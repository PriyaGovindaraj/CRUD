...
// Defined store route
vehicletypeRoutes.route('/add').post(function (req, res) {
...
// Defined edit route
vehicletypeRoutes.route('/edit/:id').get(function (req, res) {
...
vehicletypeRoutes.route('/update/:id').post(function (req, res) {
...
vehicletypeRoutes.route('/delete/:id').get(function (req, res) {
